public class Fila {
    ...
    public boolean enfileira( int i ){ //boolean para retornar se a fila estiver cheia 
    ...
    public int desenfilera(){
        ...
        int temp =  dados[primeiro]; //quem saiu da fila, antigo primeiro
